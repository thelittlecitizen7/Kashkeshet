...
namespace KashkeshetClient.MenuHandler.Options.ManagerOptions
{
    public class RemoveManagerPermissionOption : IOptions
    {
        ...
        public RemoveManagerPermissionOption(string name, ServerHandler serverHandler)
        {
            _clientname = name;
        ...
        public void Operation()
        {
            ...
            Console.WriteLine("Please enter the group name you want to remove permission to | CLICK --stop for stop type OR exit for exit option-- EXIT");
            ...
            Console.WriteLine("Please enter the group name you want to remove admin permission to | CLICK --stop for stop type OR exit for exit option-- EXIT");
        ...
        private bool ValidateName(string allConnectedUser, string name, List<string> userNamesToAdd, ChatMessageModel chat)
        {
            ...
            {
                Console.WriteLine($"The user {name} not member in group");
                return false;
            }
