...
namespace KashkeshetClient.MenuHandler.Options.ManagerOptions
{
    public class AddUserToChatOption : IOptions
    {
        ...
        public AddUserToChatOption(IContainerInterfaces containerInterfaces,IUser _user, ServerHandler serverHandler)
        {
        ...
        public void Operation()
        {
            ...
            _containerInterfaces.SystemOutput.Print("Please enter which user you want to add to chat");
            ...
            {
                RequestType = MessageType.AddUserToChat,
                lsUsers = userNames,
                GroupName = groupName
            };
